...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      "focus:ring-STONE-200 inline-block rounded-full border-2 border-stone-300 px-4 py-2.5 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:bg-stone-300  focus:text-stone-800 focus:outline-none focus:ring focus:ring-offset-2 disabled:cursor-not-allowed md:px-6 md:py-3.5",
  };
